...
tienenMismaLongitud('Paola', 'blanca');
...
function esVocal(letra){
  ...
  if(letra.length==1) {
    if(letra == 'a' || letra == 'e' || letra == 'i' || letra == 'o' || letra == 'u') {
      return texto = 'Es vocal';
    }
    //return texto = 'No es vocal';
  }
  return texto = 'Dato incorrecto';
}
esVocal('a');
